...
async def generate_scripts():
    ...
    # INDIGO WebSocket URL (Da sostituire con l'IP esatto di Babele)
    indigo_ws_url = "ws://192.168.40.X:7624"

    print("--- INIZIO GENERAZIONE ED INVIO SCRIPT ---")
    
    for request in observation_queue:
        script = generator.generate_observation(
        ...
        try:
            async with websockets.connect(indigo_ws_url) as websocket:
